...
public:
	...
	void setAttributeDateTime(const QString &name, const QDateTime &value);
...
public:
	...
	QVariantList getAttributeVariantList(const QString &name, const QVariantList &defaultValue = QVariantList()) const;
	...
	QDateTime getAttributeDateTime(const QString &name, const QDateTime &defaultValue=QDateTime()) const;
...
private:
	...
	static QVariantList strToVariantList(QString value);
