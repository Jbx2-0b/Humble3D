...
//-----------------------------------------------------------------------------------------
CNoiseHeightMap::CNoiseHeightMap(real dLength,
                                 real dWidth,
...
//-----------------------------------------------------------------------------------------
real CNoiseHeightMap::getAltitude(real x, real z) const
{
    real dAltitude = 0.;
...
//-----------------------------------------------------------------------------------------
QVector3D CNoiseHeightMap::getNormal(real x, real z) const
{
    QVector3D vNormal;
...
//-----------------------------------------------------------------------------------------
void CNoiseHeightMap::updateGeometry()
{
    //setSelectable(false);
...
//-----------------------------------------------------------------------------------------
void CNoiseHeightMap::setHeight(int l, int w, real dValue)
{
    m_Height[l + w * m_uiLineCount] = dValue;
}

//-----------------------------------------------------------------------------------------
real CNoiseHeightMap::getHeight(int l, int w) const
{
...
//-----------------------------------------------------------------------------------------
QVector3D CNoiseHeightMap::getNormal(int l, int w) const
{
    int iID = l + w * m_uiLineCount;
...
//-----------------------------------------------------------------------------------------
QVector3D CNoiseHeightMap::getPosition(int l, int w) const
{
...
//-----------------------------------------------------------------------------------------
void CNoiseHeightMap::computeNormals()
{
    // Structure locale pour calculer les normales
    struct SNormalComputer
    {
        SNormalComputer(int iLengthQuadCount, int iWidthQuadCount, CNoiseHeightMap* pHeightMap)
...
//-----------------------------------------------------------------------------------------
CNoiseHeightMap::~CNoiseHeightMap()
{
}

//-----------------------------------------------------------------------------------------
QImage CNoiseHeightMap::computeNormalMap(const QImage& heightmap, double pStrength)
{
